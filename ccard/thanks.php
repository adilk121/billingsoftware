...
<p class="text-right"><small><i class="text-danger">Online Payment</i> »  Thank you</small></p>
</div>
</div>
<hr>
</div>
...
<?php
if($pay_online_type!="manual")
{
$client_data="";
if($pay_online_invoice_id!=""){

//// FETCH CLIENT DETAILS START //
$client_sql=db_query("select * from tbl_clients where client_id='$inv_data_pay[invoice_client_id]'");
...
$sql="UPDATE tbl_invoice SET invoice_status='Paid' $client_data WHERE invoice_id='$pay_online_invoice_id' ";  
$res=db_query($sql); 
...
<div class="container bg-white">
<div class="row">
<h1 style="text-align:center; color:green; padding:50px;">Payment Successful</h1>
<!-- <h4 style="padding:20px;"><span style="color:#c52d2f">Note : </span>
				We request you to kindly email us the payment details at <a href="mailto:support@webkeyindia.com" style="text-decoration:underline;">support@webkeyindia.com</a>, so that we can keep a track of it, and activate your order on receipt of the payment with fruitful effects.</h4>
-->
