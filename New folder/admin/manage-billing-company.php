...
header("location:manage-billing-company.php?Deleted_C=$show_deleted_company");
exit;
}
...
$sql = "select * from  tbl_billing_company   where 1 and billing_company_deleted='$show_deleted_company' $search_con";
...
<span class="btn-label"><i class="fa fa-plus" aria-hidden="true"></i>
 ...
 <span class="count-num">Total : <?=db_scalar("SELECT COUNT(billing_company_id) FROM  tbl_billing_company where billing_company_deleted='$show_deleted_company'")?></span> 
  ...
  <?}?>
            ...
            <section class="content">
               <div class="row">
                   ...
                   <a href="manage-billing-company.php?Deleted_C=<?=$show_deleted_company?>">Clear</a>
                   <?}?>
               </form>
</p>
...
<a href="manage-billing-company.php?st=1&pid=<?=$line_raw["billing_company_id"]?>&Deleted_C=<?=$show_deleted_company?>"><span class="label-custom label label-default">Active</span></a>
<?php }else{?>
<a href="manage-billing-company.php?st=0&pid=<?=$line_raw["billing_company_id"]?>&Deleted_C=<?=$show_deleted_company?>"><span class="label-danger label label-default">Inactive</span></a>
<?php }?>
...
<td class="text-center v-middle">
<a href="add-edit-billing-company.php?id=<?=$line_raw["billing_company_id"]?>&Deleted_C=<?=$show_deleted_company?>"><button type="button" class="btn btn-add btn-sm" ><i class="fa fa-pencil"></i></button>
</a>                                          
</td>
