...
$show_deleted_company=$_REQUEST['Deleted_C'];
if($show_deleted_company=="")
{
  $show_deleted_company="No";
}
...
$sql = "update tbl_billing_company set        
        ...
        billing_company_online_payment_link='$billing_company_online_payment_link',  
...
header("Location:add-edit-billing-company.php?id=$_REQUEST[id]&Deleted_C=$show_deleted_company");
exit;
...
<a href="manage-billing-company.php?Deleted_C=<?=$show_deleted_company?>"><button id="btn-go-back" type="button" class="btn btn-labeled btn-inverse m-b-5 pull-right">
...
<input type="text" class="form-control" placeholder="Enter Company Name" name="billing_company_name" id="billing_company_name"  value="<?=$billing_company_name?>" required>
</div>
...
<input type="email" class="form-control" placeholder="Enter Email Address" name="billing_company_email" id="billing_company_email"  value="<?=$billing_company_email?>" required>
</div>


<div class="form-group col-lg-3">
<label>GST No.</label>
<input type="text" class="form-control" placeholder="Enter GST No." name="billing_company_gst_no" id="billing_company_gst_no"  value="<?=$billing_company_gst_no?>">
</div>

<div class="form-group col-lg-3">
<label>GST Rate %</label>
<input type="text" class="form-control" maxlength="2" placeholder="Enter GST Rate %" name="billing_company_gst_rate" id="billing_company_gst_rate"  value="<?=$billing_company_gst_rate?>" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
</div>

<div class="form-group col-lg-6">
<label>CIN No.</label>
<input type="text" class="form-control" placeholder="Enter CIN No." name="billing_company_cin_no" id="billing_company_cin_no"  value="<?=$billing_company_cin_no?>" >
</div>

<div class="form-group col-lg-4">
<label>PAN No.</label>
<input type="text" class="form-control" placeholder="Enter PAN No." name="billing_company_pan_no" id="billing_company_pan_no"  value="<?=$billing_company_pan_no?>">
</div>

<div class="form-group col-lg-4">
<label>Invoice Start No.</label>
<input type="text" class="form-control" placeholder="Enter Invoice Start No." name="billing_company_invoice_start_no" id="billing_company_invoice_start_no"  value="<?=$billing_company_invoice_start_no?>" onchange="check_invoice_no_exist(this.value)" required>
...
<input type="text" class="form-control" placeholder="Enter State Name" name="billing_company_state_name" id="billing_company_state_name"  value="<?=$billing_company_state_name?>" >
</div>

<div class="form-group col-lg-6">
<label>State Code</label>
<input type="text" class="form-control" placeholder="Enter State Code" name="billing_company_state_code" id="billing_company_state_code"  value="<?=$billing_company_state_code?>" >
</div>
...
<input type="hidden" value="<?=$show_deleted_company?>" name="Deleted_C">    
