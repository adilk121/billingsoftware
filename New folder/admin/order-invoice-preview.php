...
<?}else{?>
<b><?=$client_data_res['client_name']?></b>
<?}?>
                 ...
                 <br><?=$client_data_res['client_mobile']?>
                  <?}?>
                ...
                <?php if($_REQUEST['invoice_order_status']=="Unpaid"){?>
                  <br>
...
?>  
        <div class="col-md-12" style="width:255px; text-align:right;margin-right:-15px;">
         <!--  <p><img src="../company_logo/<?=$company_data_res['billing_company_logo']?>" width="80"></p> -->
          ...
          <p><strong>Add: </strong><?=$company_data_res['billing_company_address']?>

   <strong>Call Us:</strong><?=$company_data_res['billing_company_phone_no']?> <strong>Email:</strong><?=$company_data_res['billing_company_email']?> <strong>Website: </strong><a href="<?=$company_data_res['billing_company_website']?>" target="_blank" style="color:#374767;"><?=remove_http($company_data_res['billing_company_website'])?></a><?php if($company_data_res['billing_company_gst_no']!=""){?> <strong>GST No. </strong>:<?=$company_data_res['billing_company_gst_no']?><?}?><?php if($company_data_res['billing_company_cin_no']!=""){?><br><strong>CIN No. </strong>:<?=$company_data_res['billing_company_cin_no']?><?}?></p>
