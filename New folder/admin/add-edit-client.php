...
header("Location:add-edit-client.php?id=$_REQUEST[id]&Deleted_Client=$show_deleted_client");
exit;
...
<a href="manage-clients.php?Deleted_Client=<?=$show_deleted_client?>"><button id="btn-go-back" type="button" class="btn btn-labeled btn-inverse m-b-5 pull-right">
...
<label>CID</label>
<input type="text" class="form-control" placeholder="Enter CID" name="client_cid" id="client_cid"  value="<?=$client_cid?>">
</div>


<div class="form-group col-lg-6">
<label>Customer Name</label>
<input type="text" class="form-control" placeholder="Enter Customer Name" name="client_name" id="client_name"  value="<?=$client_name?>" onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123)" required>
</div>


<div class="form-group col-lg-6">
<label>Company Name</label>
<input type="text" class="form-control" placeholder="Enter Company Name" name="client_company_name" id="client_company_name"  value="<?=$client_company_name?>">
</div>


<div class="form-group col-lg-6">
<label>GST No.</label>
<input type="text" class="form-control" placeholder="Enter GST No." name="client_gst_no" id="client_gst_no"  value="<?=$client_gst_no?>">
</div>

<div class="form-group col-lg-6">
<label>Email Address</label>
<input type="email" class="form-control" placeholder="Enter Email Address" name="client_email" id="client_email"  value="<?=$client_email?>" required>
</div>
...
<input type="text" maxlength="10" class="form-control" placeholder="Enter Mobile No." name="client_mobile" id="client_mobile"  value="<?=$client_mobile?>" required oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
</div>
...
<div class="form-group col-lg-4">
<label>PAN No.</label>
<input type="text" class="form-control" placeholder="Enter PAN No." name="client_pan_no" id="client_pan_no"  value="<?=$client_pan_no?>">
</div>
...
<input type="text" class="form-control" placeholder="Enter State Code" name="client_state_code" id="client_state_code"  value="<?=$client_state_code?>">
</div>
...
<select name="client_status" class="form-control" >
                    ...
                    <input type="hidden" value="<?=$show_deleted_client?>" name="Deleted_Client">             
