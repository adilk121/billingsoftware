...
<body>      
  ...
  <tbody>
    <tr>
      <td vAlign='top' style='background-color:#e61938; padding:10px;font-family:Verdana, Arial, Helvetica, sans-serif; font-size:16px; color:#ffffff; text-align:center; font-weight:bold;' colspan='3' >Contact Us Enquiry From $hostName</td>
    </tr>
     <tr>
...
$subject = "Contact Us Enquiry From $hostName";
            $from="$contact_email";
...
$subject2 = "Contact Us Enquiry of $hostName";
...
.error_message_contact{
         ...
         <div class="container">
            <div class="row">
               <div class="col-lg-4 col-md-4 contact-us">
                  ...
                  <p><?=$compDATA['admin_address']?>, <?=$compDATA['admin_city']?>, <?=$compDATA['admin_state']?>, <?=$compDATA['admin_country']?> - <?=$compDATA['admin_zip_code']?></p>
                  <?}?>
                  <?php if($compDATA['admin_phone']!=""){?>
                  <h6 class="text-dark"><i class="mdi mdi-phone"></i> Phone :</h6>
                  <p><a href="tel:<?=$compDATA['admin_phone']?>"><?=$compDATA['admin_phone']?></a></p>
                  <?}?>
                  <?php if($compDATA['admin_mobile']!=""){?>
                  <h6 class="text-dark"><i class="mdi mdi-deskphone"></i> Mobile :</h6>
                  <p><a href="tel:<?=$compDATA['admin_mobile']?>"><?=$compDATA['admin_mobile']?></a></p>
                  <?}?>
                  <?php if($compDATA['admin_email']!="" || $compDATA['admin_alt_email']!=""){?>
                  <h6 class="text-dark"><i class="mdi mdi-email"></i> Email :</h6>
                  <p><a href="mailto:<?=$compDATA['admin_email']?>"><?=$compDATA['admin_email']?></a>
               ...
               <form class="col-lg-8 col-md-8" action="" method="post" enctype="multipart/form-data" onsubmit="return checkValidationContact();">
                  <div class="section-title">
                     <h2 class="mt-1 mb-5">Contact Us</h2>
                        <?=db_scalar("select site_pages_description from tbl_site_pages where site_pages_link='contact-us'");?>
                  </div>
 ...
 <?php
if($compDATA['admin_contactus_map_link']!="")
{?>
   <br>
