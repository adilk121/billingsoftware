   <?php
$hot_sql=db_query("select * from tbl_category where 1 and category_status='Active' and category_is_product='Yes' and category_is_featured='Yes' limit 6");
    ...
    <!-- Properties List -->
      <section class="section-padding">
         <div class="section-title text-center mb-5">
            <h2>Featured Office Spaces In Noida</h2>
