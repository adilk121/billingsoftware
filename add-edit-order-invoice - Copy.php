...
<select <?php if($ord_id!=0){ echo "disabled"; } ?> name="invoice_order_client_id" id="invoice_order_client_id" class="form-control" required>
...
<div class="row">
  ...
  <div class="form-group col-lg-6">
     <select name="order_status" id="order_status" class="form-control">
       <option value="Active" <?php  if($order_status=="Active"){echo "selected";} ?> >Active</option>
       <option value="Inactive" <?php  if($order_status=="Inactive"){echo "selected";} ?> >Inactive</option>
