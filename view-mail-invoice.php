...
<h4>PROFORMA INVOICE</h4>
			...
			<button class="btn btn-success printbtn" onClick="window.print();"><i class="fa fa-print"></i> Print Invoice</button>
			 <?php if($invoice_status=="Unpaid"){?>
				<button class="btn btn-primary printbtn" onClick="window.location.href='<?=$site_url?>/ccard/payment-options.html?pay_online_invoice_id=<?=$invoice_id?>'"><i class="fa fa-money-bill-alt"></i> Pay Online</button>
			<?}?>
...
?>  
   ...
   <br><strong>Website:</strong><?=remove_http($billing_comp_website)?>
...
<td class="text-right"><?=number_format((float)$bill_amount, 2, '.', '')?></td>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12" style="margin-top:5px;">
             ...
             <?=$invoice_recipient_note?>
				...
				<button class="btn btn-success printbtn" onClick="window.print();"><i class="fa fa-print"></i> Print Invoice</button>
				 <?php if($invoice_status=="Unpaid"){?>
				<button class="btn btn-primary printbtn" onClick="window.location.href='<?=$site_url?>/ccard/payment-options.html?pay_online_invoice_id=<?=$invoice_id?>'"><i class="fa fa-envelope-o"></i> Pay Online</button>
			<?}?>
			</div>
