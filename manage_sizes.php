...
$res=db_query($sql);
if($res>0){
$_SESSION['msg']="Sizes are added successfully.";	
}
...
<head>
      ...
      <title>Sales Hub : Admin Panel</title>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td  id="pageHead" colspan="2"><div class="col-lg-12 text-center bg-primary bold" style="padding:6px;font-size:16px"><i class="fa fa-bars font-black fa-lg"></i>&nbsp;Manage Product Sizes</div></td>
  </tr>
